  ...
  function _renderEmpty() {
    ...
    empty.innerHTML = `
      <div class="ac-empty-inner">
        <div class="ac-empty-glyph" aria-hidden="true">✦</div>
        <h3 class="ac-empty-headline">No workstreams yet.</h3>
        <p class="ac-empty-sub">Workstreams group meetings into themes you can navigate.</p>
        <button type="button" class="ac-empty-cta" data-ac-action="create-first">+ Create your first workstream</button>
      </div>`;
    state.container.appendChild(empty);

    empty.querySelector('[data-ac-action="create-first"]')?.addEventListener('click', () => {
