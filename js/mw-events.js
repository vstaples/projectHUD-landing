...
window._mwEventsVersion = 'v20260418-CMD58';
console.log('%c[mw-events] v20260418-CMD58 — B1 event bus: workflow_request.resolved, instance.completed','background:#c47d18;color:#000;font-weight:700;padding:2px 8px;border-radius:3px');
