...
window.renderFormsTab = function renderFormsTab(el) {
...
function _formWireMatrixHandle() { /* no-op: wired by IIFE below */ }

// ── Matrix panel drag-to-resize — persistent document listeners (cdn-core-state pattern)
(function() {
  var _dragging = false;
  var _startX   = 0;
  var _startW   = 0;
  ...
  document.addEventListener('mousemove', function(e) {
    ...
    var newPanelW = Math.max(220, Math.min(900, _startW + delta));
    var newCanvasW = Math.max(200, _startCW - delta);
