...
var AccordLiveCapture = (function () {
  ...
  function _css() {
    ...
    '.ac-lc-captured-label{font-size:11px;font-weight:700;letter-spacing:.6px;text-transform:uppercase;color:var(--lo);padding:4px 0 4px 8px}.ac-lc-captured-row{display:flex;align-items:center;gap:8px;padding:5px 10px;font-size:12px;margin-left:8px;margin-bottom:4px;border-radius:8px;box-shadow:-2px 0 0 0 var(--nt);background:rgba(72,170,136,.10);cursor:pointer;transition:background .1s}.ac-lc-captured-badge{font-size:9px;font-weight:700;border-radius:3px;padding:1px 5px;flex-shrink:0;cursor:pointer;transition:opacity .1s}.ac-lc-captured-badge:hover{opacity:.75}.ac-lc-captured-text{flex:1;color:var(--md)}.ac-lc-captured-time{color:var(--lo);flex-shrink:0;font-size:10px;margin-right:18px}' +
    ...
    // Decisions
    '.ac-lc-dec-row{display:flex;align-items:center;gap:10px;padding:5px 10px;margin-bottom:8px;margin-left:8px;border-radius:8px;box-shadow:-2px 0 0 0 var(--dec);background:#13172a;cursor:pointer;transition:background .1s}' +
    ...
    '.ac-lc-act-table{margin-left:8px;width:calc(100% - 8px);border-spacing:0 4px;border-collapse:separate}' +'.ac-lc-act-row td{background:#13172a;padding:4px 8px;vertical-align:middle}' +'.ac-lc-act-row td:first-child{border-left:2px solid var(--act);border-radius:8px 0 0 8px;padding-left:10px}' +'.ac-lc-act-row td:last-child{border-radius:0 8px 8px 0}' +'.ac-lc-act-row:hover td{background:#1a2035}' +
    ...
    // Risks
    '.ac-lc-rsk-row{display:flex;align-items:center;gap:10px;padding:5px 10px;margin-bottom:8px;margin-left:8px;border-radius:8px;box-shadow:-2px 0 0 0 var(--rsk);background:#13172a;cursor:pointer;transition:background .1s}' +
    ...
    // Parking lot
    '.ac-lc-park-row{display:flex;align-items:center;gap:10px;padding:5px 10px;margin-bottom:8px;margin-left:8px;border-radius:8px;box-shadow:-2px 0 0 0 #9478e0;background:#13172a;cursor:pointer;transition:background .1s}' +
